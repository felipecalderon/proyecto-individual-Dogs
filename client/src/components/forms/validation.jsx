function validate({nombre, imagen, pesomin, pesomax, alturamin, alturamax, vidamin, vidamax, arrTemperamentosId}) {
  ...
  let errors = {};
    ...
    if (arrTemperamentosId.length === 0) errors.arrTemperamentosId = 'Selecciona al menos 1 temperamento';
